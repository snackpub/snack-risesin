package com.risesin.systemuserservice.service.serrating;
...
import com.risesin.system.wrapper.serrating.ServiceRatingWrapper;
...
public class ServiceRatingController {
    ...
    @ApiOperation(value = "详情", notes = "传入serviceRatingId")
    ...
    @ApiOperation(value = "新增", notes = "传入serviceRating")
    public R submit(@Valid @RequestBody @ApiParam("serviceRating对象") ServiceRating value) {
        service.add(value);
    ...
    @ApiOperation(value = "修改", notes = "传入serviceRating")
    public R update(@Valid @RequestBody @ApiParam("serviceRating对象") ServiceRating value) {
    ...
    public R updateStatusById(@RequestBody ServiceRating value) {
    ...
    public R<PageResult> findSearch(@ApiParam(value = "参数集合") @RequestBody Map<String, Object> params,
        ...
        Page<ServiceRating> pages = service.findSearch(params, query);
        return R.data(ServiceRatingWrapper.build().pageVO(pages));
    }
