...
import com.risesin.system.wrapper.flowlog.UserLogWrapper;
...
public class UserLogController {
    ...
    @ApiOperation(value = "详情", notes = "传入userLogId")
    ...
    public R submit(@Valid @RequestBody @ApiParam("userLog对象") UserLog value) {
        service.add(value);
    ...
    public R update(@Valid @RequestBody @ApiParam("userLog对象") UserLog value) {
    ...
    public R updateStatusById(@RequestBody UserLog value) {
    ...
    public R<PageResult> findSearch(@ApiParam(value = "参数集合") @RequestBody Map<String, Object> params,
        ...
        Page<UserLog> page = service.findSearch(params, query);
        return R.data(UserLogWrapper.build().pageVO(page));
    }
